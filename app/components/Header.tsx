                    ...
                    <div className="main-header">
                        <div className="header-left">
                            <div className="header-logo">
                                <Link legacyBehavior href={`/${Region}/jobs/home`}><a className="d-flex"><img alt="jobBox" src="assets/imgs/template/jobhub-logo.svg" /></a></Link>
                            </div>
                        </div>
                        <div className="header-nav">
                            <nav className="nav-main-menu">
                                <ul className="main-menu">
                                    <li>
                                        <Link legacyBehavior href={`/${Region}/jobs/home`} className={'active'}>Home</Link>
                                    </li>
                                    <li>
                                        <Link legacyBehavior href={`/${Region}/jobs/our-jobs`}>Find a Job</Link>
                                    </li>
                                    <li>
                                        <Link legacyBehavior href="/">Recruiters</Link>
                                    </li>
                                    <li>
                                        <Link legacyBehavior href="/">Candidates</Link>
                                    </li>
                                    <li>
                                        <Link legacyBehavior href="/">Pages</Link>
                                    </li>
                                    <li>
                                        <Link legacyBehavior href="/">Blog</Link>
                                    </li>
                                    <li>
                                        <Link legacyBehavior href="/">Contact</Link>
                                    </li>
                        ...
                        <div className="header-right">
                            <div className="block-signin">
                                <Link legacyBehavior href="/"><a className='text-link-bd-btom hover-up'>Register</a></Link>
                                <Link legacyBehavior href="/"><a className='btn btn-default btn-shadow ml-40 hover-up'>Sign in</a></Link>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="mobile-menu-wrap mobile-header-border">
                                ...
                                <nav>
                                    <ul className="mobile-menu font-heading">
                                        ...
                                        <li>
                                            <Link legacyBehavior href="/d">Blog</Link>
                                        </li>
                                        <li>
                                            <Link legacyBehavior href="/">Contact</Link>
                                        </li>
