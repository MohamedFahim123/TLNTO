            ...
            <div className="single-body">
              ...
              <figure>
                <Image
                  ...
                  height={450}
                  alt="jobBox"
                  src="/assets/imgs/page/blog/img-content.png"
                />
              </figure>
              <div className="max-width-single">
                  ...
                  <div className="row">
                    <div className="col-lg-7">
                      <Link legacyBehavior href="#">
                        <a className="btn btn-border-3 mr-10 hover-up">
                          # Nature
                        </a>
                      </Link>
                      ...
                      <Link legacyBehavior href="#">
                        <a className="btn btn-border-3 hover-up">
                          # Travel tips
                        </a>
                      </Link>
                    </div>
                      ...
                      <Link legacyBehavior href="#">
                        <a className="mr-20 d-inline-block d-middle hover-up">
                          <Image
                            ...
                            height={15}
                            alt="jobBox"
                            src="/assets/imgs/page/blog/fb.svg"
                          />
                        </a>
                      </Link>
                      ...
                      <Link legacyBehavior href="#">
                        <a className="mr-20 d-inline-block d-middle hover-up">
                          <Image
                            ...
                            height={15}
                            alt="jobBox"
                            src="/assets/imgs/page/blog/tw.svg"
                          />
                        </a>
                      </Link>
                      ...
                      <Link legacyBehavior href="#">
                        <a className="mr-0 d-inline-block d-middle hover-up">
                          <Image
                            ...
                            height={15}
                            alt="jobBox"
                            src="/assets/imgs/page/blog/pi.svg"
                          />
                        </a>
                      </Link>
                    </div>
                    ...
                    <div className="author-bio mt-40 bg-white">
                      ...
                      <div className="author-des">
                        <p className="font-md color-text-paragraph">
                          ...
                          Phasellus interdum dignissim rhoncus. Nam vitae semper
                          magna. Donec massa enim
                        </p>
                      </div>
                    </div>
                  </li>
