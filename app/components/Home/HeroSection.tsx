                                ...
                                <div className="form-find mt-40 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                    <form>
                                        <div className="box-industry">
                                            <select title='Industry' id='industrySelect' name='industry' className="form-input mr-10 select-active input-industry">
                                        ...
                                        <div className="box-industry">
                                            <select title='Location' id='locationSelect' name='location' className="form-input mr-10 select-active input-location">
                                        ...
                                        <button type='button' title='search' className="btn btn-default btn-find font-sm">Search</button>
                                    </form>
                                </div>
